...
namespace Homework8
{
    public partial class FormAddOrder : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (radioButton1.Checked == true)
            {
                OrderService.CreateOrder((Customer)dataGridView1.CurrentRow.DataBoundItem, time);
            }
            else if (radioButton2.Checked == true)
            {
                Customer cus = new Customer(textBox1.Text, textBox2.Text);
                OrderService.CreateCustomer(cus.Name,cus.Addr);
                OrderService.CreateOrder(cus, time);
            }
